...
//(2)-------------------------------------------------------------------------------------------------
   ...
   if(Frameactual==2){
    ...
    textSize(25);
    fill(textos);
    text("Homero tendra que tener mucho cuidado! es muy peligroso...",20,450,300,550);
    textSize(20);
    fill(indicaciones);
    text("[presiona Backspace para ingresar]",0,570);
  }
  //(3)---------------------------------------------------------------------------------
  ...
  if(Frameactual==0){
   ...
   image(flechaH,100,370);
    ...
    textSize(20);
    fill(indicaciones);
    text("[presione con mouse una de las flechas]",0,560);
 ...
 //(9)-------------------------------------------------------------------------------------
   ...
   //(10)------------------------------------------------------------------------------------
    ...
    //(11)----------------------------------------------------------------------------------
      ...
      textSize(20);
      fill(indicaciones);
      text("[presiona enter para finalizar]",500,590);
      textSize(25);
      fill(textos);
      text("Al dia siguente Lisa Simpsons les brindo un homenaje a sus seres queridos por el trajico desenlace del incendio, devido a que homero se quemo al intentar rescatar a sus familiares.",20,400,600,600);
    }
    //(12)-------------------------------------------------------------------------------------
      ...
      textSize(20);
      fill(indicaciones);
      text("[presiona Backspace para finalizar]",450,590);
      textSize(30);
      fill(amarillo);
      text("¡Homero logro salvar a su familia!",100,50,600,200);
       textSize(25);
      fill(textos);
      text("El grandioso acto de Homero se difundio por todo Springfiel, lo que genero que homero sea considerado un heroe para la ciudad ,pero principalmente para su familia.",20,100,500,400);
    }
    //(13)---------------------------------------------------------------------------------------------
